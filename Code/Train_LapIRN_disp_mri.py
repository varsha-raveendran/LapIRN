...
import monai
import wandb
from mri_liver import MRILiverPairwiseFixed
...
def train_lvl1():
    ...
    train_dataset =  MRILiverPairwiseFixed("/home/varsha/data/Liver_2d/", 
                                                 'pairwise_with_fixed.json',
                                downsampled=False, 
    ...
    training_generator = Data.DataLoader(train_dataset, batch_size=1,
