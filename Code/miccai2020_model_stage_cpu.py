...
class Miccai2020_LDR_laplacian_unit_add_lvl1(nn.Module):
    ...
    def forward(self, x, y):
        ...
        #From Git: denotes the concatenated input x and y, and in BCHWD format, down_y denotes the downsampled input y and is in BCHWD format. 
        # cat_input_lvl1[:, 1:2, :, :, :] This operation selects the second element in C(Channel) dimension, which is the input y.
